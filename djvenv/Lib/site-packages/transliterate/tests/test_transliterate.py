...
class TransliterateTest(unittest.TestCase):
    ...
    def test_31_override_settings(self):
        ...
        self.assertEqual(
            defaults.LANGUAGE_DETECTION_MAX_NUM_KEYWORDS, override_settings()
        )
    ...
    def test_33_register_unregister(self):
        ...
        self.assertTrue(
            res
            and ArmenianLanguagePack.language_code not in get_available_language_codes()
        )
    ...
    def __test_29_mappings(self):
        ...
        for language_pack in get_available_language_packs():
            ...
            for letter in language_pack.mapping[1]:
                LOGGER.debug(
                    (
                        letter,
                        " --> ",
                        translit(letter, language_pack.language_code, reversed=True),
                    )
                )
            ...
            for letter in language_pack.mapping[0]:
                LOGGER.debug(
                    (letter, " --> ", translit(letter, language_pack.language_code))
                )
